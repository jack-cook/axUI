...
public class DataNode<S> {
    ...
    @IntDef({CHILD_POSITION_FOOTER, CHILD_POSITION_HEADER, CHILD_POSITION_MIDDLE})
...
*/
     ...
     */
    protected void onChildNodeAdded(DataNode addedNode, @ChildPosition int position) {
     ...
     */
    protected void onChildNodeRemoved(DataNode removedNode, @ChildPosition int position) {
    ...
    private void onInternalNodeAdd(DataNode dataNode, @ChildPosition int position) {
